...
public class FenMarshallerTest {
    ...
    public void testTransformation() {
        ...
        ChessPosition initialPosition = rules.getInitialPosition();
        String initialPositionAsFen = positionMarshaller.convertPositionToString(initialPosition);
        Assertions.assertThat(initialPositionAsFen).isEqualTo("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");

        ChessPosition positionE4 = applyAndSwitch(rules, pgnMarshaller, initialPosition, "e4");
        ...
        ChessPosition positionC5 = applyAndSwitch(rules, pgnMarshaller, positionE4, "c5");
        ...
        ChessPosition positionNf3 = applyAndSwitch(rules, pgnMarshaller, positionC5, "Nf3");
